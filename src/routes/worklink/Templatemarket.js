...
import styles from './Templatemarket.css';
                    ...
                    renderItem={item => (
                      <List.Item className={styles.listitem}>
                        <Content className={styles.content}>
                          ...
                          <span className={styles.contentspan}>申请内容：1111</span><br />
                          <Button size="small" className={styles.contentbutton}>立即使用</Button>
...
export default connect(mapStateToProps)(Templatemarket);
