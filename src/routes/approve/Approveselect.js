          ...
          <Row type="flex" className={styles.colstyle}>
            <Col span={6} order={1} className={styles.colstyle}>
              <FormItem
                ...
                wrapperCol={{ span: 14 }}
              >
                <Button type="primary" className={styles.padleft}>查询</Button>
      ...
      <Content style={{ height: '300px', overflow: 'auto' }}>
        <Layout className={styles.listtopbg}>
          <Row type="flex">
            ...
            <Col className={styles.follow} span={5} order={2}>
              <Content className={styles.content}>
            ...
            <Col className={styles.follow} span={4} order={2}>
              <Content className={styles.content}>
                <span className={styles.contentspanr}>申请时间</span>
              </Content>
            </Col>
            ...
            <Col className={styles.follow} span={4} order={2}>
              <Content className={styles.content}>
                <span className={styles.contentspanr}>审批结果</span>
              </Content>
            </Col>
            ...
            <List.Item className={styles.listitem}>
              <Layout>
                <Row type="flex">
                  <Col className={styles.follow} span={4} order={2}>
                    <Content className={styles.content}>
                      <span className={styles.contentspanr}>BC123456</span>
                    </Content>
                  </Col>
                  <Col className={styles.follow} span={5} order={2}>
                    <Content className={styles.content}>
                      <span className={styles.contentspanr}>任务完成【123456】</span>
                    </Content>
                  </Col>
                  <Col className={styles.follow} span={4} order={2}>
                    <Content className={styles.content}>
                      <span className={styles.contentspanr}>2018/01/21</span>
                    </Content>
                  </Col>
                  <Col className={styles.follow} span={3} order={2}>
                    <Content className={styles.content}>
                  ...
                  <Col className={styles.follow} span={4} order={2}>
                    <Content className={styles.content}>
                      <span className={styles.contentspanr}>审批中</span>
                    </Content>
                  </Col>
                  <Col className={styles.follow} span={4} order={4}>
                    <Content className={styles.content}>
